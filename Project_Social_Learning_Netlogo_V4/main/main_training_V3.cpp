 ...
 *---------------------------------------------------------------------------*/
 /* Iterations:																 */
 #define ITERA_TRAINING    1000	/* Iteration number (robot steps) during
 ...
 #define TRIALS            1	/* number of times robots are rerolled and
								   ...
								   inheritance								 */
 #define GENERATIONS       10 //40	/* number of generation in GA training		 */								   								   
 ...
 #define FOOD_ITEMS		   5 //5000  /* nr of food items in the arena			 */
 #define FOOD_SIZE		     3  /* size of the food items					 */
 #define FOOD_EFFECT		 10  /* effect of food items on agent energy      */
 
 #define P_size				10  /* size of the population of robots			 */
 #define Best_N				2  /* the best N idividual robots				 */
 #define E					0  /* initial energy of robots					 */
 #define MV					0.2 /* genetic variance normal distribution      */
 #define Nr_of_NN			2   /* the number of NN to be stored in file at 
 								   //the end of training    					 */
